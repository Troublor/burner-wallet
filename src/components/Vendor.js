        ...
        let productIsActive = (
          <button className="btn btn-large w-100"
            onClick={()=>{
              ...
              tx(contracts[this.props.ERC20VENDOR].addProduct(prod.id,prod.name,prod.cost,!prod.isAvailable),240000,0,0,(result)=>{//TODO undeployable: ERC20 unavailable
      ...
      <div className="main-card card w-100">
        <div className="content bridge row">
          ...
          <button className="btn btn-large w-100" style={buttonStyle.secondary} onClick={()=>{
            ...
            tx(contracts[this.props.ERC20VENDOR].activateVendor(setActiveTo),120000,0,0,(result)=>{//TODO undeployable: ERC20 unavailable
        ...
        <div className="content bridge row">
          ...
          <button className="btn btn-large w-100" style={buttonStyle.secondary} onClick={()=>{
            if(!this.state.newProductName || !this.state.newProductAmount){
              ...
              tx(contracts[this.props.ERC20VENDOR].addProduct(nextId,web3.utils.utf8ToHex(this.state.newProductName),web3.utils.toWei(""+this.state.newProductAmount, 'ether'),true),240000,0,0,(receipt)=>{//TODO undeployable: ERC20 unavailable
